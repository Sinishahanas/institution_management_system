 ...
 *
 * Commonly used to ensure valid user input when configuring schedules
 * such as working hours, automation routines, or timed events.
 *
...
/**
 * @purpose TypeScript type inferred from `courseFormSchema`.
 *
 * This type represents the validated structure of a course form object,
 * ensuring compile-time type safety when handling validated course data.
 *
 * @type {object}
...
/**
 * @purpose Helper function for validating time strings in HH:MM format (24-hour clock).
 *
...
/**
 * @purpose TypeScript type inferred from `branchFormSchema`.
 *
 * Represents the validated structure of a branch form.
 *
 * @type {object}
...
/**
 * @purpose Defines the validation schema for transportation mode using Zod.
 *
 * This schema validates information related to a transportation mode, ensuring
 * mode name, rate, and per-day value are provided and meet the required rules.
 *
...
/**
 * @purpose TypeScript type inferred from `transportationModeFormSchema`.
 *
 * Represents the validated structure of a transportation mode entry.
 *
 * @type {object}
...
/**
 * Studio Form Schema
 * @purpose Defines the validation schema for a studio form using Zod.
 *
 * This schema validates basic studio information, including its name and
...
/**
 * @purpose TypeScript type inferred from `studioFormSchema`.
 *
 * Represents the validated structure of a studio form.
 *
 * @type {object}
...
/**
 * @purpose BranchAdminCourses React component — manages UI and state for course-related
 * admin operations (courses, batches, branches, departments, schedules, transportation,
 * studios, brands). Provides dialog state, selected-item state, and integrates with
 * toast notifications for user feedback.
 *
 * The component centralizes local UI state for many admin flows (create/update/delete),
 * and is intended to be rendered inside an admin layout or route. It does not accept props.
 *
 * @param {void} none - This component takes no props.
 * @returns {JSX.Element} The rendered BranchAdminCourses component tree (JSX).
 * @throws {None} This component does not throw. Validation/operations performed by
 * called APIs or handlers may throw and should be handled where those calls occur.
 * @sideEffects
 ...
 * import BranchAdminCourses from "@/branchAdmin/BranchAdminCourses";
 *
 * function AdminPage() {
 *   return (
 *     <AdminLayout>
...
export default function BranchAdminCourses() {
  ...
  */
   ...
   * @param batchId - The ID of the batch to retrieve schedules for.
   * @returns Array of schedule objects containing day, startTime, endTime, and duration.
   ...
   * @param row - Table row object containing batch data (row.original.id is used as batchId)
   * @returns JSX element displaying the student count or "Loading..." if count is not yet fetched.
