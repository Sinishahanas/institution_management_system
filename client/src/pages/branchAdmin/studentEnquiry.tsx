...
/**
 * BranchAdminStudentEnquiry — React component for managing student enquiries.
 *
 * @purpose Displays a list of not-joined students, allows creating, viewing, and editing students.
...
export default function BranchAdminStudentEnquiry() {
    ...
    /**
     * Fetches all users for parent selection.
     *
     * @param None
     * @returns {Object} React Query result object
    ...
    /**
     * Filter all users to return only parents for dropdown selection.
     *
     * @type {User[]}
    ...
    /**
     * URLDialogEffect — Opens the create dialog if URL contains `openDialog=create`.
     *
     * @param None
     * @returns None
     * @throws None
     ...
     * - Uses `useMutation` from React Query to create a student via POST request.
     * - Handles updating the query cache, resetting form state, and displaying toast notifications on success or error.
     * 
    ...
    /**
     * @purpose Opens the student details view dialog.
     *
     * @param {Student} student - The student object to view.
     * @returns {void}
     * @throws None
     *
     * @sideEffects
     * - Sets `selectedStudent` with the student details.
     * - Opens the view dialog by setting `isViewDialogOpen` to true.
     *
     * @example
    ...
    /**
     * Opens the edit dialog and sets the form data for the selected student.
     *
     ...
     *
     * @sideEffects
     * - Sets `selectedStudent` and updates `formData` with student details.
     ...
     * - Calls `createStudentMutation.mutateAsync` to create the student.
     * - Displays toast notifications for validation errors or success/failure.
     *
     * @example
     ...
     *
     * @sideEffects
     * - Calls `updateStudentMutation.mutate` to update the selected student.
     * - Converts age to a number before sending.
     *
     * @example
    ...
    /**
     * handlePrintInvoice — Navigates to invoice print page.
     *
     * @params
    ...
    /**
     * filteredStudents — Filters students based on the active tab (status).
     *
    ...
    /**
     * columns — Defines the columns for the student table.
     *
     * @param None
