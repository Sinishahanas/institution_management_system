...
/**
 * BranchAdminReports Component
 *
 * @purpose Displays administrative reports for a branch, including revenue, student distribution,
 * branch performance, and attendance charts.
 *
 * @param none
 * @returns {JSX.Element} The component rendering branch admin reports.
 * @sideEffects Uses React state (`useState`) for `reportPeriod` and `activeTab`.
 * @throws none
 *
 * @example
 * ```tsx
 * import BranchAdminReports from "@/components/BranchAdminReports";
 * 
 * export default function Dashboard() {
 *   return <BranchAdminReports />;
 * }
 * ```
 */
export default function BranchAdminReports() {
   ...
   *
   * @purpose Represents monthly revenue, expenses, and profit for the branch.
   *
   * @param none
   * @returns {Array<{month: string, revenue: number, expenses: number, profit: number}>}
   * @sideEffects none
   * @throws none
   *
   * @example
   * ```ts
   * revenueData[0]; // { month: "Jan", revenue: 750000, expenses: 420000, profit: 330000 }
   * ```
   */
  const revenueData = [
   ...
   *
   * @purpose Represents the distribution of students across courses.
   *
   * @param none
   ...
   * @example
   * ```ts
   * studentDistributionData[0]; // { name: "Music", value: 650, color: "#3949ab" }
   * ```
   */
   ...
   *
   * @purpose Summarizes performance metrics for each branch including students, revenue, and profit.
   *
   * @param none
   * @returns {Array<{name: string, students: number, revenue: number, profit: number}>}
   * @sideEffects none
   * @throws none
   *
   * @example
   * ```ts
   * branchPerformanceData[0]; // { name: "Main Branch", students: 540, revenue: 650000, profit: 320000 }
   * ```
   */
   ...
   * Attendance data
   *
   * @purpose Tracks monthly student attendance percentages.
   *
   * @param none
   * @returns {Array<{month: string, attendance: number}>}
   * @sideEffects none
   * @throws none
   *
   * @example
   * ```ts
   * attendanceData[0]; // { month: "Jan", attendance: 92 }
   * ```
   */
   ...
   *
   * @purpose Converts a number into a human-readable string with ₹ symbol and K/M suffix.
   *
   * @param {number} amount - The numeric amount to format.
   * @returns {string} Formatted amount as a string with suffix.
   * @sideEffects none
   * @throws {TypeError} Throws if the input is not a number.
   *
   * @example
   * ```ts
   * formatLargeAmount(750000); // "₹750.0K"
   * formatLargeAmount(1150000); // "₹1.2M"
   * formatLargeAmount(500); // "₹500"
   * ```
   */
  ...
  return (
    // AppShell wrapps the page with the app shell layout
    <AppShell>
      {/* PageHeader displays the page title, description, and actions */}
      <PageHeader
      ...
      {/* Tabs component is used to switch between different views */}
      ...
      <div className="flex flex-col sm:flex-row gap-4 items-center justify-between mb-6">
        ...
        {/* Switch between different report periods */}
      ...
      {/* TabsContent displays the content of the selected tab */}
      <TabsContent value="revenue" className="mt-0">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          {/* Card displays the total revenue */}
          <Card>
          ...
          {/* Card displays the total expenses */}
          <Card>
            <CardHeader className="pb-2">
        ...
        {/* Card displays the revenue overview */}
        <Card className="mb-6">
          <CardHeader>
          ...
          <CardContent>
            <div className="h-96">
              ...
              <ResponsiveContainer width="100%" height="100%">
                ...
                >
                  {/* CartesianGrid is used to add grid lines to the chart */}
        ...
        {/* Card displays the revenue by course category */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Card>
            ...
            <CardContent>
              <div className="h-64">
                <ResponsiveContainer width="100%" height="100%">
                  {/* PieChart is used to create a pie chart */}
                  <PieChart>
                    <Pie
          ...
          {/* Card displays the monthly profit trend */}
          <Card>
            <CardHeader>
            ...
            <CardContent>
              <div className="h-64">
                <ResponsiveContainer width="100%" height="100%">
                  {/* LineChart is used to create a line chart */}
                  <LineChart
                    data={revenueData}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          <Card>
            <CardHeader>
              ...
              {/* CardDescription displays the description of the card */}
          ...
          <Card>
            ...
            <CardContent className="h-80">
              <ResponsiveContainer width="100%" height="100%">
                {/* BarChart is used to create a bar chart */}
                <BarChart
                  data={[
                    { age: "5-8", count: 210 },
                    { age: "9-12", count: 380 },
        ...
        <Card>
          ...
          <CardContent className="h-80">
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                <CartesianGrid strokeDasharray="3 3" vertical={false} />
                {/* XAxis is used to create an x-axis */}
                <XAxis dataKey="month" />
                {/* YAxis is used to create a y-axis */}
                <YAxis />
                {/* Tooltip is used to display a tooltip */}
                <Tooltip />
                {/* Legend is used to display the legend of the chart */}
                <Legend />
                {/* Line is used to create a line chart */}
                <Line
                  type="monotone"
                  dataKey="enrollments"
      ...
      <TabsContent value="attendance" className="mt-0">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          {/* Card to show average attendance */}
          <Card>
            <CardHeader className="pb-2">
          ...
          {/* Card to show highest attendance */}
          <Card>
            <CardHeader className="pb-2">
          ...
          {/* Card to show lowest attendance */}
          <Card>
            <CardHeader className="pb-2">
        ...
        {/* Card to show attendance trends */}
        <Card className="mb-6">
          <CardHeader>
        ...
        {/* Card to show attendance by day of week */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Card>
            <CardHeader>
          ...
          {/* Card to show attendance by course category */}
          <Card>
            <CardHeader>
