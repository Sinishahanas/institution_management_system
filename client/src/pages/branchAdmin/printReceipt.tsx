 ...
 *
 * @purpose
 * Defines the structure of a receipt object used in the system to display
 * or print student payment information.
 *
...
/**
 * BranchAdminPrintReceipt — React component to display a printable receipt.
 *
 * @purpose Fetches a receipt by its `receiptNumber` from the backend and renders
 *   a print-friendly receipt with a letterhead, footer, and relevant details.
 * @returns {JSX.Element} A fully rendered receipt view ready for printing.
...
export default function BranchAdminPrintReceipt() {
  ...
  /**
   * Fetches a receipt based on the `receiptNumber` from either admin or branch-admin routes
   * and manages loading and error states.
   *
   * @purpose
   * Retrieves receipt data from the backend API (`/api/receipts/:receiptNumber`) for
   * displaying or printing a student payment receipt.
   *
   * @param receiptNumber
