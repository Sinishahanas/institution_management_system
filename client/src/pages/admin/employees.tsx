...
export default function AdminEmployees() {
  ...
  /**
   * @purpose Opens the view dialog for a selected employee.
   *
   * @param employee - Employee object to view.
   * @returns void
   * @throws None
   * @sideEffects Updates state to open dialog and set selected employee.
   *
   * @example
   * ```ts
   ...
   * @returns Array<ColumnDef<Employee>> - Columns definition for the employees data table.
   * @throws None
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="mt-6">
        ...
        <TabsContent value={activeTab} className="mt-6">
          <DataTable
            ...
            data={filteredEmployees} //Filtered employee data
            searchColumns={["employeeId"]} //Columns to search by
            searchPlaceholder="Search employees..." //Search placeholder input
          />
        </TabsContent>
      </Tabs>
