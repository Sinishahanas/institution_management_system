 ...
 * 
 * @example
 * // Mount this route in your router: <Route path="/admin/print-invoice/:invoiceId" component={PrintInvoice} />
          ...
          <div>
            {invoice.remarks && (
              ...
              {/* If remarks are present, display them */}
                ...
                <p className="text-gray-600 border p-2 rounded max-w-xs">
                  {invoice.remarks}
                </p>
              </>
            )}
