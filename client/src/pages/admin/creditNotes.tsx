 ...
 *
 * @param {string} creditNoteNumber - Unique identifier for the credit note.
 * @param {number} studentId - ID of the student the credit note applies to.
 * @param {number} [appliedInvoiceId] - Optional ID of the invoice the credit note applies to.
 * @param {number} amount - Amount of the credit note. Must be greater than 0.
 * @param {string} generatedMonth - Month in "YYYY-MM" format when the credit note is generated.
 * @param {string} [appliedToType] - Optional type describing what the credit note is applied to.
 * @param {string} reason - Reason for issuing the credit note.
 * @param {string} status - Status of the credit note (e.g., "pending", "approved").
 * @returns {CreditNoteFormValues} The validated credit note form values.
...
export default function CreditNotes() {
   ...
   *
   * @purpose Tracks which student is selected in the form in order to fetch related invoices.
   *
   * @param None
   ...
   * @example
   * ```ts
   * const { data: invoices, isLoading: isLoadingInvoices } = useInvoices(selectedStudentId);
   * ```
   */
  const {
    data: invoices = [],
  ...
  */
   ...
   *
   * @purpose Provides options for the credit note generation month dropdown.
   *
   * @param None
  ...
  const columns: ColumnDef<CreditNote>[] = [
    {
      ...
      header: "SL.No.",
      /**
       * @purpose Renders the serial number based on the sorted row index.
       *
    ...
    },
    {
      ...
      /**
       * @purpose Renders the credit note number as a clickable link to print the note.
       *
       * @param row - Current row object.
    ...
    },
    {
      ...
      header: "Student",
      /**
       * @purpose Renders the student name based on `studentId`.
       *
       * @param row - Current row object.
    ...
    },
    {
      ...
      /**
       * @purpose Renders the type of application for the credit note, capitalized.
       *
       * @param row - Current row object.
    ...
    },
    {
      ...
      /**
       * @purpose Renders the invoice number linked to the credit note.
       *
       * @param row - Current row object.
    ...
    },
    {
      ...
      header: "Amount",
      /**
       * @purpose Renders the credit note amount formatted as currency.
       *
       * @param row - Current row object.
    ...
    },
    {
      ...
      /**
       * @purpose Renders the generated month of the credit note.
       *
       * @param row - Current row object.
    ...
    },
    {
      ...
      header: "Reason",
      /**
       * @purpose Renders the reason for the credit note.
       *
       * @param row - Current row object.
    ...
    },
    {
      ...
      header: "Created At",
      /**
       * @purpose Renders the creation date of the credit note.
       *
       * @param row - Current row object.
    ...
    },
    {
      ...
      header: "Status",
      /**
       * @purpose Renders the status of the credit note with a badge.
       *
       * @param row - Current row object.
    ...
    },
    {
      ...
      header: "Actions",
      /**
       * @purpose Renders action buttons for each credit note row.
       *
       * @param row - Current row object.
          ...
          <Form {...creditNoteForm}>
            <form onSubmit={creditNoteForm.handleSubmit(onSubmitCreditNoteForm)} className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                {/* If appliedToType is "against invoice", show invoice dropdown */}
