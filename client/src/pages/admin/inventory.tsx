 ...
 * @returns {InventoryFormValues} Validated inventory form object containing `items` and `amount`.
 * @throws Throws Zod validation errors if:
 *   - `items` is empty
 ...
 *
 * @param None
 * @returns JSX.Element - The rendered Admin Inventory page.
...
export default function AdminInventory() {
  ...
  return (
    // AppShell component is used to provide a consistent layout structure with sidebars, headers, and footers
    <AppShell>
