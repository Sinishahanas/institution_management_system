 ...
 *
 * @type {object}
 * @param {string} name - Brand name (required).
 * @param {string} [description] - Brand description (optional).
 * @returns {void}
 * @throws {None}
 * @sideEffects None
 *
 ...
 *
 * @type {object}
 * @param {string} name - Department name (required).
 * @param {string} [description] - Department description (optional).
 * @returns {void}
 * @throws {None}
 * @sideEffects None
 *
 ...
 * @purpose Defines the validation schema for a schedule form using Zod.
 *
 ...
 *
 * Commonly used to ensure valid user input when configuring schedules such as working hours, automation routines, or timed events.
 *
 ...
 *
 * @type {object}
 * @param {string} day - Selected day(s) for the schedule (required).
 * @param {string} startTime - Start time for the schedule (required).
 * @param {string} endTime - End time for the schedule (required).
 * @returns {void}
 * @throws {None}
 * @sideEffects None
 *
 ...
 *
 * @type {object}
 * @param {string} code - Course code (required).
 * @param {string} name - Course name (required).
 * @param {number} brandId - ID of the selected brand (required).
 * @param {string} category - Course category (required).
 * @param {number} fee - Course fee (must be greater than 0).
 * @returns {void}
 * @throws {None}
 * @sideEffects None
 *
 ...
 *
 * @type {object}
 * @param {string} name - Name of the batch (required).
 * @param {number} courseId - ID of the associated course (required).
 * @param {number} perDayValue - Daily fee for the batch (≥ 0.01).
 * @param {number} teacherId - ID of the assigned teacher (required).
 * @param {string} startDate - Batch start date (valid date string).
 * @param {string|null} [endDate] - Optional end date (valid date string or null).
 * @param {Array<{day: string, startTime: string, endTime: string, duration?: number}>} schedules - List of batch schedules.
 * @param {string} [roomNumber] - Optional classroom identifier.
 * @param {number} [capacity] - Optional batch capacity.
 * @param {string} category - Batch category (required).
 * @param {string} branch - Branch name or location (required).
 * @param {"active" | "completed" | "cancelled"} status - Batch status (default: `"active"`).
 * @returns {void}
 * @throws {None}
 * @sideEffects None
 *
 ...
 * @param {number[]} brandIds - List of associated brand IDs.
 * @param {string} phone - Branch phone number.
 * @param {string|null} [manager] - Optional branch manager.
 * @param {"active" | "inactive"} status - Branch status.
 * @returns {void}
 * @throws {None}
 * @sideEffects None
 *
 ...
 *
 * @type {object}
 * @param {string} mode - Mode of transportation.
 * @param {number} rate - Rate for transportation (must be > 0).
 * @param {number} perDayValue - Per-day cost (must be ≥ 0.01).
 * @returns {void}
 * @throws {None}
 * @sideEffects None
 *
 ...
 * @param {string} [description] - Optional description of the studio.
 * @returns {void}
 * @throws {None}
 * @sideEffects None
 *
...
/**
 * @purpose Manages UI and state for course-related admin operations (courses, batches, branches, departments, schedules, transportation, studios, brands). Provides dialog state, selected-item state, and integrates with toast notifications for user feedback.
 *
 * @param {void} None
 * @returns {JSX.Element} The rendered BranchAdmin component tree (JSX).
 ...
 * import BranchAdmin from "@/admin/BranchAdmin";
 *
 * function AdminPage() {
 *   return (
 *     <AdminLayout>
...
export default function BranchAdmin() {
   ...
   *
   * This state object is used to filter displayed data based on user input, such as name, brand, course, per-day value, branch, category, schedule day, start/end times, duration, teacher, room number, or capacity.
   *
   * @type {object}
   * @param {string} name - Filter by name.
   * @param {string} brandId - Filter by brand ID.
   * @param {string} courseId - Filter by course ID.
   * @param {string} perDayValue - Filter by per-day fee value.
   * @param {string} branch - Filter by branch name.
   * @param {string} category - Filter by category name.
   * @param {string} day - Filter by schedule day.
   * @param {string} startTime - Filter by schedule start time.
   * @param {string} endTime - Filter by schedule end time.
   * @param {string} duration - Filter by schedule duration.
   * @param {string} teacherId - Filter by teacher ID.
   * @param {string} roomNumber - Filter by room number.
   * @param {string} capacity - Filter by batch capacity.
   *
   * @returns {void}
   * @throws {None}
   * @sideEffects None
  ...
  /**
   * Calculates the duration in minutes for a schedule in the batch creation form
   * and updates the form state.
   *
   * @purpose Compute duration between startTime and endTime of a schedule.
   *
  ...
  /**
   * Calculates the duration in minutes for a schedule in the batch edit form and updates the form state.
   * @purpose Compute duration between startTime and endTime of a schedule in the edit batch form.
   *
  ...
  */
   ...
   * Form hook for creating a brand.
   *
  ...
  */
   ...
   *
   * @example
   * onEditDepartmentSubmit({ name: "Music Department", description: "Department for music courses" });
   */
   ...
   * @throws {Error} If the provided branch object is invalid or if `branchForm.reset()` encounters an unexpected error.
   *
   * @example
   ...
   * @returns {void}
   * @throws {Error} If the provided branch object is invalid or if a state update (e.g., `setSelectedBranch`) fails unexpectedly.
   ...
   * @returns {void}
   * @throws {Error} If the provided batch object is invalid or if `editBatchForm.reset()` encounters an unexpected error.
   ...
   * @returns {void}
   * @throws {Error} If the provided batch object is invalid or if a state update (e.g., `setSelectedBatch`) fails unexpectedly.
