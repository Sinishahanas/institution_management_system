 ...
 * @param {string} paymentId - Unique ID for the payment.
 * @param {string[]} invoiceNumber - Array of invoice numbers being paid. Must contain at least one.
 * @param {number} studentId - ID of the student associated with the payment. Required.
 * @param {string} [invoiceAmount] - Optional total invoice amount as string.
 * @param {number} amount - Amount being paid. Must be greater than 0. Required.
 * @param {Date} paymentDate - Date of payment. Required.
 * @param {string} status - Payment status. Required.
 * @param {string} [paymentMethod] - Optional payment method.
 * @param {string} [remarks] - Optional remarks for the payment.
 ...
 * @param {string} receiptNumber - Unique receipt number. Required.
 * @param {string} paymentId - ID of the associated payment. Required.
 * @param {Date} receiptDate - Date when the receipt was issued. Required.
 * @param {string} invoiceDate - Date of the invoice associated with the payment. Required.
 * @param {number} amount - Payment amount. Must be greater than 0. Required.
 * @param {string} paymentMethod - Method used for the payment. Required.
 * @param {string} [remarks] - Optional remarks for the receipt.
 * @throws {ZodError} Throws if validation fails.
...
export default function AdminPayments() {
   ...
   *
   * @param {object} react-query result object. `data` will be StudentPayment[] when resolved.
   ...
   *
   * @purpose Calculate the total amount for all selected unpaid invoices and write that value (formatted) into the payment form's `invoiceAmount`.
   *
   * @params
    ...
    try {
      ...
      if (isPayingAgaInstitutionnvoices) {
        ...
        for (const invoice of invoiceUpdates) {
          ...
          // Record payment item linking payment to invoice
          ...
          // Create a receipt for this allocation (generate receipt number first)
        ...
        // No invoices selected — treat as advance payment
   ...
   *
   * @param {number | string} studentId — the id to search for (can be numeric or string).
